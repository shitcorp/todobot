...
module.exports = {
     ...
     "Errors": {
        ...
        "generalerror": {
            `Ett problem har intreäffat. Om det kvarstår kan du kontakta support via discord (/support) kommandot, eller skapa ett inlägg på [github](${pkg.bugs.url})`
        },
        "permissionleveltoolow": {
            "Du har inte tillräckligt höga rättigheter för detta kommando."
        },
        "blacklisted": {
            "Du eller kanalen du är i är svartlistad."
        }
     }
     ...
     "Reactions": {
        ...
        "timeisuperror": {
            "Du misslyckades att svara i tid!"
        }
     }
     ...
     "TODO": {
        ...
        "cantclosetodo": {
            "Du kan inte stänga den här TODO om du inte har slutfört alla uppgifter."
        },
        "alreadyassigned": {
            "Du är redan tilldelad."
        },
        "novalidkey": {
        ...
        "only10tasksallowed": {
            "Endast 10 uppgifter är tillåtna, så jag begränsade din uppgiftslista vid 10."
        }
     }

     "Query": {
        "nothingfound": {
            "Det hittades inget som matchade dina sökkriterier."
        },
        "databaseerror": {
            "Något gick fel när vi försökte fråga databasen."
        },
        "nosearchcriteria": {
            "Du gav inga sökkriterier efter \`WHERE\` nyckelordet."
        },
        "wrongqueryselector": {
     ...
     "Tag": {
        "cantoverwritecommands": {
            "Du kan inte överskrida bot-kommandon eller alias med taggar."
        },
        "tagalreadyexists": {
            "Den här taggen finns redan, tabort den först innan du skriver över.."
        },
        "descriptiontoolong": {
            "Din beskrivning var för lång. Från \`1000\` tillgängliga tecken använde du: "
        },
        "tagsaved": {
            "Sparade den nya taggen åt dig. Sammanfattning: "
        },
        "tagdoesnotexist": {
            "Den här taggen verkar inte finnas."
        },
        "tagunlearned": {
            "Avlärde taggen: "
        },
     ...
     "Shorten": {
        "nolinkgiven": {
            "Du har glömt att ange en länk för att förkorta."
        },
        "backendoffline": {
            `Backend verkar vara offline. Försök kanske senare?... 
            Om problemet kvarstår, vänligen kontakta utvecklarna på discord eller öppna ett problem på [github](${pkg.bugs.url})`
        },
        "somethingwentwrong": {
            "Något gick fel när jag försökte hämta din länk"
        },
        "notacceptablelink": {
            "Länken du vill förkorta verkar inte vara acceptabel."
        },
        "toomanyrequests": {
            "För många förfrågningar, försök igen senare."
        },
        "shortenedurl": {
            "Här är din förkortade URL. \nTänk på att den löper ut om 24 timmar. \n"
        },
     ...
     "Blacklist": {
        "useralreadyblacklisted": {
            "Användaren är redan svartlistad."
        },
        "updatedyourblacklist": {
            "Uppdaterade din svartlista."
        },
        "channelalreadyblacklisted": {
            "Kanalen är redan svartlistad."
        },
        "usernotblacklisted": {
            "Användaren är inte svartlistad."
        },
        "channelnotblacklisted": {
            "Kanalen är inte svartlistad."
        },
        "noitemsonblacklist": {
            "För närvarande finns det inga objekt på dina svartlistor."
        },
        "cannotblacklistbots": {
            "Du kan inte svartlista bots."
        },
        "nouserorchannelgiven": {
            "Du måste ge en användare eller kanal som du vill svartlista."
        }
     }
     ...
     "Reminder": {
        ...
        "contenttoolarge": {
            "Ditt innehåll är för stort, från 400 tillgängliga tecken använde du"
        },
        "remindercreated": {
            "Din nya påminnelse skapades!"
        },
        "updatedreminder": {
            "Uppdaterad din påminnelse."
        },
        "deletedreminder": {
            "Tog bort din påminnelse."
        },
     }

     "Support": {
        "supportmessage": {
            `Kontakta supporten via discord [Klicka här](https://discord.gg/RuEdX5T "https://discord.gg/RuEdX5T").             
     ...
     "Help": {
        ...
        "moreinformation": {
            "För mer information om ett specifikt kommando skriv \`/help <kommando>\`."
        },
        "commandnotfound": {
     ...
     "Assign": {
        "cannotassignbots": {
            "Du kan inte tilldela bots."
        },
        "tododoesntexist": {
            "Denna TODO verkar inte existera."
        },
        "useralreadyassigned": {
            "Denna användare har redan tilldelats."
        }
     }

     "Settings": {
        "savedsettings": {
            "Sparade dina nya inställningar."
        },
        "rolenotinarray": {
            "Denna roll finns inte i din användar/staff-lista."
        }
     }

     "Suggest": {
        "requestsubmitted": {
            "Ditt förslag eller förfrågan har skickats in."
        },
        "errorposting": {
     ...
     "Variables": {
        "savedvar": {
            "Sparade din nya variabel. \n__**Summary:**__"
        },
        "varalreadyexists": {
            "Denna variabel finns redan."
        },
        "updatedvar": {
            "Uppdaterade din variabel. \n__**Summary:**__"
        },
        "varmustexist": {
            "Du kan bara ta bort variabler som finns."
        },
        "deletedvar": {
            "Raderade variabeln med namnet: "
        }
     }
