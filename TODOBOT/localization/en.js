...
module.exports = {
     ...
     "Errors": {
        ...
        "generalerror": {
            `An error occured, please try again. If the error persits, join the support discord (/support), or open an issue on [github](${pkg.bugs.url})`
        },
        "permissionleveltoolow": {
            "You can not use this command because your permission level is too low."
        },
        "blacklisted": {
            "Either you or the channel you are in, are blacklisted fro bot usage."
        }
     }
     ...
     "TODO": {
        ...
        "cantclosetodo": {
            'You can\'t close this TODO unless you have finished all tasks.'
        },
        "alreadyassigned": {
        ...
        "only10tasksallowed": {
            "Only 10 tasks are allowed, so i capped your task list at 10."
        }
     }

     "Query": {
        "nothingfound": {
            "There was nothing found matching your search criteria."
        },
        "databaseerror": {
            "Something went wrong when trying to query the database."
        },
        "nosearchcriteria": {
            "You didnt give any search criteria afer the \`WHERE\` keyword."
        },
        "wrongqueryselector": {
     ...
     "Tag": {
        "cantoverwritecommands": {
            "You cant override bot commands or aliases with tags."
        },
        "tagalreadyexists": {
            "This tag already exists, unlearn it first before overwriting.."
        },
        "descriptiontoolong": {
            "Your description was too long. From \`1000\` available characters you used: "
        },
        "tagsaved": {
            "Saved the new tag for you. Summary: "
        },
        "tagdoesnotexist": {
     ...
     "Shorten": {
        "nolinkgiven": {
            "You forgot to enter a link to shorten."
        },
        "backendoffline": {
            `The backend seems to be offline. Maybe try again later?... 
            If the problem persists please contact the developers on discord or open an issue on [github](${pkg.bugs.url})`
        },
        "somethingwentwrong": {
            "Something went wrong while trying to fetch your link"
        },
        "notacceptablelink": {
            "The link you want to shorten does not seem to be acceptable."
        },
        "toomanyrequests": {
     ...
     "Blacklist": {
        ...
        "noitemsonblacklist": {
            "Currently there are no items on your blacklists."
        },
        "cannotblacklistbots": {
            "You cannot blacklist bots."
        },
        "nouserorchannelgiven": {
            "You need to give a user or channel that you want to blacklist."
        }
     }
     ...
     "Reminder": {
        ...
        "contenttoolarge": {
            "Your Content is too large, from 400 available characters you used"
        },
        "remindercreated": {
            "Your new reminder was created!"
        },
        "updatedreminder": {
            "Updated your reminder."
        },
        "deletedreminder": {
     ...
     "Support": {
        "supportmessage": {
            `To join the support discord [click here](https://discord.gg/RuEdX5T "https://discord.gg/RuEdX5T").             
     ...
     "Invite": {
        'invitemessage': {
            '[Invite me to your server.](http://invite.todo-bot.xyz "http://invite.todo-bot.xyz")'
        }
     }
     ...
     "Assign": {
        "cannotassignbots": {
            "You cannot assign bots."
        },
        "tododoesntexist": {
            "This TODO does not seem to exist."
        },
        "useralreadyassigned": {
     ...
     "Settings": {
        "savedsettings": {
            "Saved your new settings."
        },
        "rolenotinarray": {
            "This role is not in your user- or  staffroles array."
        }
     }

     "Suggest": {
        "requestsubmitted": {
            "Your suggestion or feature request has been submitted."
        },
        "errorposting": {
     ...
     "Variables": {
        "savedvar": {
            "Saved your new Variable. \n__**Summary:**__"
        },
        "varalreadyexists": {
            "This variable already exists."
        },
        "updatedvar": {
            "Updated your Variable. \n__**Summary:**__"
        },
        "varmustexist": {
            "You can only delete variables that exist."
        },
        "deletedvar": {
            "Deleted the variable with the name: "
        }
     }
