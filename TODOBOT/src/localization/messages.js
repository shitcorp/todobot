...
module.exports = {
    ...
    addbottoguild: {
        ...
        de:
            'Ich habe keine Konfiguration für deinen Server gefunden. Um eine zu erstellen, benutze bitte den `/settings set` command',
    },
    ...
    blacklisted: {
        ...
        de:
            'Entweder du, oder der channel in dem du bist wurden geblacklisted und du kannst den bot hier nicht benutzen.',
    },
    ...
    todoposted: {
        ...
        de:
            'Super! Deine neue Aufgabe wurde gepostet, Reagiere mit  <:accept_todo:822495794602442814>  um dich der Aufgabe anzunehmen und mit  <:finish:820576533059600394>  wenn du fertig mit der Aufgabe bist.',
    },
    ...
    novalidkey: {
        ...
        de:
            'Diese Einstellung kann nicht bearbeitet werden. Verfügbare Einstellungen sind: title, attachment, loop, state, content und category.',
    },
    ...
    noreadonlychannel: {
        ...
        de:
            'Du hast keinen read only channel in deiner config festgelegt. Um das zu tun, benutze den comand /settings set readonlychannel: #irgendeinchannel',
    },
    ...
    notodochannel: {
        ...
        de:
            'Du hast keinen todo channel eingestellt. Das kannst du ändern mit dem Command `/settings set todochannel: #deinchannel`',
    },
    ...
    noopenreminders: {
        ...
        de:
            'Momentan hast du keine offenen reminder. Um mehr über das Reminder Feature herauszufinden, benutze den comand `/help reminder`.',
    },
    ...
    moreinformation: {
        ...
        de:
            'Für mehr informationen über einen speziellen command benutze den help command folgendermaßen: `/help <commandname>`',
    },
    ...
    errorposting: {
        ...
        de:
            'Es ist ein Fehler aufgetreten beim Posten deiner Suggestion. War der Link zu deinem Bild vielleicht falsch?',
    },
